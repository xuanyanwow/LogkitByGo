...
// arModel is a active record design model for table siam_api_log operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of siam_api_log.
	Table = "siam_api_log"
	// Model is the model object of siam_api_log.
