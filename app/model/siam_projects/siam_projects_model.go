...
// arModel is a active record design model for table siam_projects operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of siam_projects.
	Table = "siam_projects"
	// Model is the model object of siam_projects.
