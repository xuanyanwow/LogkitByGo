...
// arModel is a active record design model for table siam_abnormals operations.
type arModel struct {
	M *gdb.Model
}

var (
	// Table is the table name of siam_abnormals.
	Table = "siam_abnormals"
	// Model is the model object of siam_abnormals.
